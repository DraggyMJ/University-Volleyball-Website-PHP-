...
<footer class="admin">
        ...
        <div>
            <?php printf('<nav class="footer_nav">
                <ul>
                    <li><a href="AdminInfo.php?name=%s"><h2>Info</h2></a></li>
                    <li><a href="homeAdmin.php?name=%s"><h2>Home</h2></a></li>
                    <li><a href="eventAdmin.php?name=%s"><h2>Event</h2></a></li>
                    <li><a href="feedbackadmin.php?name=%s"><h2>Feedback</h2></a></li>
                </ul>
            </nav>
        </div>
        <div class="website">
